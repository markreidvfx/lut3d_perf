...
# NOTE: you might need to run this with: bash build_gcc.sh

BUILD_DIR="${ROOT}/build"
SRC_DIR="${ROOT}/src"
RESULT_DIR="${ROOT}/results_gcc"
...
g++ -O2 -std=c++11 -c "${SRC_DIR}/deps/tinyexr.cpp" -I"${SRC_DIR}/deps/miniz" -o tinyexr.o
g++ -O2 -std=c++11 -c "${SRC_DIR}/tetrahedral_ocio.cpp" -o ocio.o
gcc -O2 -msse2 -mavx2 -mfma -c "${SRC_DIR}/lut3d_perf.c" -o lut3d_perf.o
g++ -O2 -std=c++11 lut3d_perf.o ocio.o tinyexr.o lut3d_asm_release.o -o ../lut3d_perf_gcc
...
cd "${RESULT_DIR}"
../lut3d_perf_gcc ../samples/images/$SAMPLE ../samples/luts/$LUT